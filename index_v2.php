...
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Ahmad Turmudi"; ?></p>
        ...
        $alamat_perpus = "Jl. Pendidikan No. 123, Jombang";
        $telepon_perpus= "021-12345678";
        $jam_buka      = "08:00";
        $jam_tutup     = "16:00";
        ...
        <div class="info">
         ...
         <div class="card" style="border: 1px solid #ddd;">
            <h3>ℹ️ Informasi Perpustakaan</h3>

...
<body>
   <div class="container mt-5">
      ...
      <?php
      // Data judul buku
      $judul = "pemograman web dengan php dan mysql";
      $pengarang = "Ahmad Turmudi";
      $deskripsi = "Buku ini membahas pemogramn web menggunaka PHP  dan MYSQL secara lengkap dari dasar hingga mahir";
      ?>
      ...
      <div class="card mb-3">
         ...
         <div class="card-body">
            ...
            <p><strong>Karakter Pertama Deskripsi: </strong><br>
               ...
               <!-- str_replace() -->
            <p><strong>Keplace "PHP" menjadi "PHP 8" : </strong><br>
               <?php echo strtoupper($judul); ?> </p>
            ...
            <p><strong> Trim Spasi: </strong><br>
               Sebelum : "<?php echo strtoupper($judul); ?>" (panjang : <?php echo strlen($judul_spasi); ?>)<br>
